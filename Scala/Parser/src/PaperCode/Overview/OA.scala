...
def parseWithAlg[E](inp: String)(alg: ExprAlg[E]): E = {
  val p = new ExprParser[E] {}.pExpr(alg)
  parse[E](p)(inp)
}

println(parseWithAlg("x y")(new ExprPrint{}))
//END_OVERVIEW_OA_USE
*/
...
println(parseWithAlg("\\x.(x y)")(new CollectFreeVars {}))
