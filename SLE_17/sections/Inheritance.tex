...
\lstinline{super[T].x}, called \textit{static super reference}. It refers to the type or
method \inlinecode{x} in the specified parent trait \inlinecode{T}. With this we can reuse
