...
\bruno{Independent extensibility cannot be explained like this. 
We need to see some code here! You need to expand the explanation. 
I suggest instead cutting on the ``wrong'' attempt in the beggining of this section, and instead 
have some brief discussion in the \emph{correct} code where we need to be careful.}
