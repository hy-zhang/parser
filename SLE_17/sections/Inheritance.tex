...
\lstinputlisting[linerange=29-31]{code/Sec3Inheritance/Code1.scala}% APPLY:linerange=INHERITANCE_SIMPLE_LAM
...
\lstinputlisting[linerange=35-38]{code/Sec3Inheritance/Code1.scala}% APPLY:linerange=INHERITANCE_BAD_ATTEMPT
...
\lstinputlisting[linerange=42-47]{code/Sec3Inheritance/Code1.scala}% APPLY:linerange=INHERITANCE_APPROACH
...
\lstinputlisting[linerange=67-73]{code/Sec3Inheritance/Code1.scala}% APPLY:linerange=MULTIPLE_INHERITANCE
...
\lstinputlisting[linerange=79-95]{code/Sec3Inheritance/Code1.scala}% APPLY:linerange=BOOL_EXAMPLE
