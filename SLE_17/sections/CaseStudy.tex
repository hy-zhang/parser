...
\begin{figure}[ht]
\lstinputlisting[linerange=15-33]{code/src/papercode/Sec6CaseStudy/Code1.scala}% APPLY:linerange=CASESTUDY_VARAPP
...
\lstinputlisting[linerange=9-11]{code/src/papercode/Sec6CaseStudy/Code1.scala}% APPLY:linerange=CASESTUDY_EPARSER
...
\begin{figure}[t]
\lstinputlisting[linerange=37-64]{code/src/papercode/Sec6CaseStudy/Code1.scala}% APPLY:linerange=CASESTUDY_UNTYPED
...
\lstinputlisting[linerange=68-78]{code/src/papercode/Sec6CaseStudy/Code1.scala}% APPLY:linerange=CASESTUDY_DEMO
