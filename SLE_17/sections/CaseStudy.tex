...
implemented parsers of the first 18 calculi~\footnote{There are some more calculi in the book,
  but they are either not ported by the implementation we compare with, or just repeating the syntax of former ones.}
from book \textit{Types and Programming Languages} (TAPL) \cite{pierce2002types}.
