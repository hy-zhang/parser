...
\begin{figure}[ht]
\lstinputlisting[linerange=15-33]{code/Sec6CaseStudy/Code1.scala}% APPLY:linerange=CASESTUDY_VARAPP
...
\lstinputlisting[linerange=9-11]{code/Sec6CaseStudy/Code1.scala}% APPLY:linerange=CASESTUDY_EPARSER
...
\begin{figure}[t]
\lstinputlisting[linerange=37-64]{code/Sec6CaseStudy/Code1.scala}% APPLY:linerange=CASESTUDY_UNTYPED
...
\lstinputlisting[linerange=68-78]{code/Sec6CaseStudy/Code1.scala}% APPLY:linerange=CASESTUDY_DEMO
