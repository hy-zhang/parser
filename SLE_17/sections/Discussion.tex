...
\begin{figure}[ht]
\lstinputlisting[linerange=31-59]{code/Sec4OA/Code4.scala}% APPLY:linerange=OVERVIEW_OA_MULTI_SYNTAX
...
\lstinputlisting[linerange=63-66]{code/Sec4OA/Code4.scala}% APPLY:linerange=OVERVIEW_OA_MULTI_SYNTAX_CLIENT
...
\lstinputlisting[linerange=76-81]{code/Sec5/Code1.scala}% APPLY:linerange=BASEPARSER_UNTYPEDLAM
...
\lstinputlisting[linerange=85-90]{code/Sec5/Code1.scala}% APPLY:linerange=EXTPARSER_TYPEDLAM
...
\begin{figure}[t]
\lstinputlisting[linerange=113-132]{code/Sec5/Code1.scala}% APPLY:linerange=LANGUAGE_COMPONENTS_VAREXPR
\lstinputlisting[linerange=136-156]{code/Sec5/Code1.scala}% APPLY:linerange=LANGUAGE_COMPONENTS_TYPEDLAM
...
\begin{figure}[t]
\lstinputlisting[linerange=160-170]{code/Sec5/Code1.scala}% APPLY:linerange=LANGUAGE_COMPONENTS_VARLAMEXPR
