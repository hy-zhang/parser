...
\begin{figure}[t]
\centering
\lstinputlisting[linerange=42-53]{code/Sec2Packrat/Code2.scala}% APPLY:linerange=PACKRAT_PAPERCODE
...
\lstinputlisting[linerange=9-17]{code/Sec2Packrat/Code1.scala}% APPLY:linerange=PACKRAT_OO_AST
...
\lstinputlisting[linerange=21-29]{code/Sec2Packrat/Code1.scala}% APPLY:linerange=PACKRAT_SIMPLE_EXPR
...
\lstinputlisting[linerange=33-33]{code/Sec2Packrat/Code2.scala}% APPLY:linerange=PACKRAT_RUNPARSER
