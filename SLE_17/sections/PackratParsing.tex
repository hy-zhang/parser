...
\vspace{-4pt}
\lstinputlisting[linerange=9-13]{code/src/papercode/Sec2Packrat/Code1.scala}% APPLY:linerange=PACKRAT_OO_AST
\vspace{-4pt}
...
\vspace{-4pt}
\lstinputlisting[linerange=17-24]{code/src/papercode/Sec2Packrat/Code1.scala}% APPLY:linerange=PACKRAT_SIMPLE_EXPR
\vspace{-4pt}
