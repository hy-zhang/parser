...
\vspace{-4pt}
\lstinputlisting[linerange=5-7]{code/src/papercode/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_ALG
\vspace{-4pt}
...
\vspace{-4pt}
\lstinputlisting[linerange=11-14]{code/src/papercode/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_PRINT
\vspace{-4pt}
...
%\lstinputlisting[linerange=18-20]{code/src/papercode/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_EVAL
...
\vspace{-4pt}
\lstinputlisting[linerange=24-25]{code/src/papercode/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_ALGEXT
\vspace{-4pt}
Now pretty-printing on the new language can be realized without modifying existing code:

\vspace{-4pt}
\lstinputlisting[linerange=29-30]{code/src/papercode/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_EXTPRINT
\vspace{-4pt}
...
\vspace{-4pt}
\lstinputlisting[linerange=37-38]{code/src/papercode/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_MAKEEXP
\vspace{-4pt}
...
\vspace{-4pt}
\lstinputlisting[linerange=8-16]{code/src/papercode/Sec4OA/Code3.scala}% APPLY:linerange=BASE_OA_PARSER_BAD
\vspace{-4pt}
...
\begin{figure}
  \lstinputlisting[linerange=20-28]{code/src/papercode/Sec4OA/Code3.scala}% APPLY:linerange=BASE_OA_PARSER
...
\vspace{-4pt}
\lstinputlisting[linerange=32-36]{code/src/papercode/Sec4OA/Code3.scala}% APPLY:linerange=EXT_OA_PARSER
\vspace{-4pt}
