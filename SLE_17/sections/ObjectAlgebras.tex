...
\lstinputlisting[linerange=23-23]{code/Sec4OA/Code1.scala}% APPLY:linerange=FVARSEXPR
...
\lstinputlisting[linerange=27-37]{code/Sec4OA/Code1.scala}% APPLY:linerange=FVAR_CLASSES
...
\lstinputlisting[linerange=5-8]{code/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_ALG
...
\lstinputlisting[linerange=12-15]{code/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_PRINT
...
\lstinputlisting[linerange=19-22]{code/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_EVAL
...
\lstinputlisting[linerange=26-28]{code/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_ALGEXT
Now pretty-printing on the new language can be realized without modifying existing code:

\lstinputlisting[linerange=32-34]{code/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_EXTPRINT
...
\lstinputlisting[linerange=41-41]{code/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_MAKEEXP
...
\lstinputlisting[linerange=8-16]{code/Sec4OA/Code3.scala}% APPLY:linerange=BASE_OA_PARSER_BAD
...
\lstinputlisting[linerange=23-30]{code/Sec4OA/Code3.scala}% APPLY:linerange=BASE_OA_PARSER
...
\lstinputlisting[linerange=34-39]{code/Sec4OA/Code3.scala}% APPLY:linerange=EXT_OA_PARSER
...
\lstinputlisting[linerange=43-46]{code/Sec4OA/Code3.scala}% APPLY:linerange=EXT_OA_PARSER_CLIENT
...
\lstinputlisting[linerange=45-56]{code/Sec4OA/Code2.scala}% APPLY:linerange=OVERVIEW_OA_REFACTOR
