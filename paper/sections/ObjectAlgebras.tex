...
It refers to one Scala solution to the Expression Problem.\huang{what's the solution? is it successful?} But then programmers have to define new classes for literals, additions and variables
...
\huang{to polish}Object Algebras captures a design pattern to address the Expression Problem nicely,
...
To create an expression of \inlinecode{VarExprAlg}, a generic method is defined as follows:
