...
\paragraph{Extensibility} Various design patterns~\cite{}\huang{???} in multiple
...
type-safe extensibility~\cite{torgerson,odersky,Oliveira09,Oliveira:2012,Wang16}.\huang{not in the bib file, pls fix}
...
It is worth mentioning that Scala case classes~\cite{}\huang{???} provide a near
