...
\lstinputlisting[linerange=24-30]{../Scala/Parser/src/PaperCode/SampleParser.scala}% APPLY:linerange=OPENRECURSION_FIB

\noindent An alternative implementation using open recursion is:

\lstinputlisting[linerange=34-40]{../Scala/Parser/src/PaperCode/SampleParser.scala}% APPLY:linerange=OPENRECURSION_FIB2
...
\lstinputlisting[linerange=44-44]{../Scala/Parser/src/PaperCode/SampleParser.scala}% APPLY:linerange=OPENRECURSION_FIB_FIX

In Scala the lazy fixpoint combinator is straightforwardly implemented~\cite{} as follows:

\lstinputlisting[linerange=20-20]{../Scala/Parser/src/PaperCode/SampleParser.scala}% APPLY:linerange=OPENRECURSION_FIX
...
\lstinputlisting[linerange=48-51]{../Scala/Parser/src/PaperCode/SampleParser.scala}% APPLY:linerange=OPENRECURSION_COMPOSE
...
\lstinputlisting[linerange=55-55]{../Scala/Parser/src/PaperCode/SampleParser.scala}% APPLY:linerange=OPENRECURSION_SHOW
...
\lstinputlisting[linerange=59-60]{../Scala/Parser/src/PaperCode/SampleParser.scala}% APPLY:linerange=OPENRECURSION_MERGE
