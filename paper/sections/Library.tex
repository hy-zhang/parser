...
% more subsections: object algebras (different syntax, separate variant and behavior, two dimensions of extensibility, generics), lexing, traits, language composition (more extensibility)
