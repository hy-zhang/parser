...
\bruno{Well, if we need to present the lexing code, then it is better 
to present the code for the enclosing type as well. Instead of 
just saying this in the text.}
