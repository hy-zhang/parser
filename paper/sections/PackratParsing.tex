...
grammar, but after rewrite the result is $1((-2)-3))$\bruno{??This is
  not a valid expression}. The parse tree
...
in parser combinator libraries is the need for manually prioratizing/ordering
...
complexity in Parsec, because it does not have proive optimizations
for backtracking.
