...
corresponding parsing code, we continue with the expression language of literals and additions in Section~\ref{subsec:packratparsing}. We introduce variables as a new case:
...
alternative.\bruno{Don't be abstract! Use concrete examples. You 
