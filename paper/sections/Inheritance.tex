...
Scala has a linearized-style multiple inheritance for traits~\cite{odersky2004overview}. This can be very helpful when composing several languages, which
...
alternative. The new parser can be built by inheriting both parsers
at the same time:
