...
Engineering~\cite{McIlroy68}. Modern Programming Languages enable a certain
...
virtual classes~\cite{Ernst:2006}, as 
...
Algebras~\cite{Oliveira:2012} are one such technique, which 
Most semantic
...
\item {\bf Algorithmic challenges:} answer Packrat parsing

\item {\bf Typing and Reusability Challenges:} answer Multiple
  inheritance and Object Algebras.
