...
\begin{abstract}
  ...
  present a technique based parsing combinators that enables modular
  ...
  Extensibility is achieved using \emph{Object Algebras}.  To evaluate
  the approach we conduct a case study based on the ``Types and
  Programming Languages'' interpreters. The case study the
  effectiveness at reusing parsing code from existing interpreters,
  and the total parsing code is 68\% shorter than the non-modular
  parsing code.
