...
\begin{abstract}
  ...
  builts on top of a Packrat parsing library, but adds new parsing
...
\input{sections/PackratParsers.tex}

\input{sections/OpenRecursion.tex}

\input{sections/ObjectAlgebras.tex}
\input{sections/ParsingLibrary.tex}
