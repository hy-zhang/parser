...
\input{sections/Library/OpenRecursion.tex}
\input{sections/Library/ObjectAlgebras.tex}
\input{sections/Library/ParsingLibrary.tex}
\input{sections/Library/FirstTry.tex}
\input{sections/Library/ParserCombinators.tex} % Move to 3.3 Parsing Library: Packrat parsers (mention that 3.1 - 3.3 are orthogonal to one another and to parsing)
\input{sections/Library/DifferentSyntax.tex}
